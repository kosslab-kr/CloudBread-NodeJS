const server_arg = process.argv[2];
const user_arg = process.argv[3];
const password_arg = process.argv[4];
const db_arg = process.argv[5];
...
console.log('index.js process end!');
